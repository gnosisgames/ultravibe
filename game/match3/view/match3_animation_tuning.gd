...
const FLOOR_TRIGGER_JUICE_FALLBACK := 0.45
const FLOOR_TRIGGER_JUICE_MIN := 0.12
const FLOOR_FLOAT_STAGGER_FALLBACK := 0.06
const FLOOR_FLOAT_STAGGER_MIN := 0.02
const INTER_STEP_DELAY_FALLBACK := 0.05
const INTER_STEP_DELAY_MIN := 0.02
const POST_SPAWN_DESTROY_DELAY_FALLBACK := 0.16
const POST_SPAWN_DESTROY_DELAY_MIN := 0.04
const FLOOR_POP_AFTER_DESTROY_DELAY_FALLBACK := 0.08
const FLOOR_POP_AFTER_DESTROY_DELAY_MIN := 0.02
const DESTROY_STEP_PAUSE_FALLBACK := 0.14
const DESTROY_STEP_PAUSE_MIN := 0.04
